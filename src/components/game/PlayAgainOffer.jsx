  ...
  return (
    ...
    >
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className={`text-sm font-medium ${name === state.myName ? 'text-white' : 'text-gray-400'}`}>
                {name}
                {name === state.myName && <span className="text-gray-600 font-normal ml-1">(you)</span>}
              </span>
            </div>
      ...
      <div className="p-6 pt-4 flex flex-col gap-3">
        <p className="text-gray-600 text-xs text-center mb-1">the host wants to play again</p>
        <button
